...
return [
    ...
    */
    ...
    | Esto permite especificar rápidamente una línea de idioma personalizada
    ...
    */
    ...
    | marcador de posición de nuestro atributo por algo más legible, como
    | "Dirección de correo electrónico" en lugar de "email". Esto simplemente
    | nos ayuda a hacer nuestros mensajes más expresivos.
    |
    */
